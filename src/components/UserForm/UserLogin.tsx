...
const UserLogin: React.FC<UserFormProps> = ({ closeForm }) => {
        ...
        <>
            {showForm && (
                <div className={styles.user}>
                    <button className={styles.user__close} onClick={closeForm}>
                    ...
                    <form onSubmit={handleSubmit} className={styles.user__form}>
                        ...
                        />
                        <button className={styles.user__button}>Log in</button>
                    </form>
                    <button
                        onClick={toggleForm}
                        type="button"
